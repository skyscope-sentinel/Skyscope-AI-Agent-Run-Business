...
# Ultimate Enterprise Suite Builder v1.0.0 (CONDA EDITION)
# ====================================
...
echo -e "${MAGENTA}  ╚══════╝╚═╝  ╚═══╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝  ╚═╝╚═╝╚══════╝╚══════╝${NC}"
echo ""
echo "                      Ultimate Enterprise Suite Builder v1.0.0 (CONDA EDITION)"
echo ""
echo "                      ===================================="
echo ""
...
log_section "Installing Conda Packages"
...
conda install -y numpy pandas matplotlib seaborn scikit-learn || log_warning "Some basic packages failed to install"

# Install cytoolz from conda-forge (avoids the Cython compilation issues)
log_info "Installing cytoolz from conda-forge..."
conda install -y -c conda-forge cytoolz || log_warning "cytoolz installation failed, but we'll continue"
...
if [[ "$is_apple_silicon" == true ]]; then
    ...
    conda install -y tensorflow || log_warning "TensorFlow installation failed"
fi

# Install PyQt6 and GUI components
...
pip install web3 pycoingecko python-binance || log_warning "Some blockchain packages failed to install"

# Install eth-brownie with proper dependencies
log_info "Installing eth-brownie prerequisites..."
conda install -y -c conda-forge toolz eth-utils eth-abi eth-keys eth-typing hexbytes || log_warning "eth-brownie prerequisites installation failed"

log_info "Installing eth-brownie..."
pip install eth-brownie || log_warning "eth-brownie installation failed, but we'll continue"

# Install development tools
log_section "Installing Development Tools"
conda install -y pytest black mypy flake8 autopep8 isort || log_warning "Development tools installation failed"
