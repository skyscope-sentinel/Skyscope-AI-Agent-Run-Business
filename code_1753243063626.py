# 5. OpenWebUI Integration (Fixed Unicode)
...
<body>
    ...
    <script>
        ...
        function browseFiles() {
            addMessage('System', 'File browser activated.');
        }
    </script>
</body>
</html>"""
